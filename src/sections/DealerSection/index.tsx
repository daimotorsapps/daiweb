...
<div
role="none" className="box-border caret-transparent gap-x-[16.7857px] flex flex-col auto-cols-[minmax(0px,1fr)] grid-cols-[repeat(3,minmax(0px,1fr))] grid-rows-[auto] min-h-[auto] min-w-[auto] gap-y-[16.7857px] w-full md:gap-x-[29.7143px] md:grid md:gap-y-[29.7143px]" >
<DealerCard
...
title="Concesionarios" description="Busca nuestros concesionarios oficiales." buttonText="Buscar"
...
title="Talleres" description="Busca nuestros talleres oficiales." buttonText="Buscar"
...
title="Comparador" description="Compara modelos y descubre cuál cubre tus necesidades." buttonText="Buscar"
linkHref="/comparador"
