                    ...
                    <div className="items-start box-border caret-transparent col-end-[span_7] justify-start min-h-[auto] min-w-[auto] w-full">
                        <div className="box-border caret-transparent h-full">
                            <div role="list" className="box-border caret-transparent h-full">
                                <div
                                    role="listitem"
                                    className="relative text-white items-end bg-[url('https://cdn.prod.website-files.com/695d3a709b2e0524dd305631/69bac6362f65866933e248c3_Hyundai%20Motor%20Group%20Exhibition%20Booth%20at%20H2%26FC%20EXPO%20Tokyo%2C%20Japan.jpg')] bg-no-repeat bg-cover box-border caret-transparent flex h-full bg-center pt-40 pb-[28.1964px] px-[28.1964px] md:pb-[31.4286px] md:px-[31.4286px]"
                                >
